...
"""
    ...
    def _categorize_question(self, question: str) -> Optional[str]:
        ...
        # Check technical first as it's more specific
        if any(word in question_lower for word in ['technical', 'technology', 'stack', 'performance', 'platform', 'requirement']):
            return 'technical'
        elif any(word in question_lower for word in ['functionality', 'feature', 'does', 'purpose', 'solve']):
